...
namespace Native
{
    ...
    /// <summary>
    /// This class provides a simple way to access to functions inside NtDll.dll
    /// 
    /// Note : 
    /// ULONGLONG : https://docs.microsoft.com/en-us/openspecs/windows_protocols/ms-dtyp/c57d9fba-12ef-4853-b0d5-a6f472b50388 : ulong
    /// LARGE_INTEGER  : https://stackoverflow.com/questions/683491/how-to-declarate-large-integer-in-c-sharp : Microsoft.VisualStudio.OLE.Interop.LARGE_INTEGER | ulong
    /// SIZE_T : https://openclassrooms.com/forum/sujet/quel-est-la-difference-entre-un-sizet-et-un-int-55723 , https://stopbyte.com/t/whats-the-equivalent-of-c-size-t-in-c/334 , https://docs.microsoft.com/en-us/cpp/c-runtime-library/standard-types?view=msvc-160 : uint | UIntPtr
    /// UCHAR : https://stackoverflow.com/questions/23005206/which-datatype-is-used-for-unsigned-char-in-c
    ...
    public class NtDll
    {
        ...
        public sealed class Functions
        {
            ...
            /// <summary>
            /// This function can acquire special privileges if needed. Some of them require admin rights. See example.
            /// </summary>
            /// <param name="Privilege"></param>
            /// <param name="bEnablePrivilege"></param>
            /// <param name="IsThreadPrivilege"></param>
            /// <param name="PreviousValue"></param>
            /// <example>
            /// <code>
            /// 
            /// bool t1;
            /// RtlAdjustPrivilege(_PRIVILEGES.SeShutdownPrivilege, true, false, out t1); 
            /// 
            /// </code>
            /// </example>
            /// <returns>NTSTATUS</returns>
            [DllImport("ntdll.dll")]
            public static extern NTSTATUS RtlAdjustPrivilege(Enumerations._PRIVILEGES Privilege, bool bEnablePrivilege, bool IsThreadPrivilege, out bool PreviousValue);


            /// <summary>
            /// This function provokes a hard error and combined with privilege SE_SHUTDOWN + OptionShutdownSystem invokes BSOD.
            /// </summary>
            /// <param name="ErrorStatus"></param>
            /// <param name="NumberOfParameters"></param>
            /// <param name="UnicodeStringParameterMask"></param>
            /// <param name="Parameters"></param>
            /// <param name="ValidResponseOption"></param>
            /// <param name="Response"></param>
            /// <example>
            /// <code>
            /// 
            /// _HARDERROR_RESPONSE t2;
            /// NtRaiseHardError(errorCode, 0, 0, IntPtr.Zero, _HARDERROR_RESPONSE_OPTION.OptionShutdownSystem, out t2);
            /// 
            /// </code>
            /// </example>
            /// <returns>NTSTATUS</returns>
            [DllImport("ntdll.dll")]
            public static extern NTSTATUS NtRaiseHardError(uint ErrorStatus, uint NumberOfParameters, uint UnicodeStringParameterMask, IntPtr Parameters, Enumerations._HARDERROR_RESPONSE_OPTION ValidResponseOption, out Enumerations._HARDERROR_RESPONSE Response);


            /// <summary>
            /// This function shuts down the computer .Privilege SE_SHUTDOWN Required.
            /// </summary>
            /// <param name="Action"></param>
            /// <returns></returns>
            [DllImport("ntdll.dll")]
            public static extern NTSTATUS NtShutdownSystem([In] Enumerations._SHUTDOWN_ACTION Action);


            /// <summary>
            /// This function retrieves many information about OS.
            /// For the SystemInformationLength : http://undocumented.ntinternals.net/index.html?page=UserMode%2FUndocumented%20Functions%2FSystem%20Information%2FSYSTEM_INFORMATION_CLASS.html
            /// </summary>
            ...
            /// int nLength = 0;
            /// while (NtDll.Functions.NtQuerySystemInformation(NtDll.Enumerations._SYSTEM_INFORMATION_CLASS.SystemBootEnvironmentInformation, ipHandlePointer, nHandleInfoSize, ref nLength) == NtDll.NTSTATUS.STATUS_INFO_LENGTH_MISMATCH)
            /// {
            ...
            /// _SYSTEM_BOOT_ENVIRONMENT_INFORMATION strstr = new _SYSTEM_BOOT_ENVIRONMENT_INFORMATION();
            /// strstr = (_SYSTEM_BOOT_ENVIRONMENT_INFORMATION)Marshal.PtrToStructure(ipHandlePointer, strstr.GetType());
            /// MessageBox.Show(strstr.FirmwareType.ToString());
            /// 
            /// </code>
            /// </example>
            /// <returns>NTSTATUS</returns>
            [DllImport("ntdll.dll")]
            public static extern NTSTATUS NtQuerySystemInformation(Enumerations._SYSTEM_INFORMATION_CLASS SystemInformationClass, IntPtr SystemInformation, int SystemInformationLength, out int ReturnLength);
            [DllImport("ntdll.dll", CharSet = CharSet.Unicode)]
            public static unsafe extern NTSTATUS NtQuerySystemInformation(Enumerations._SYSTEM_INFORMATION_CLASS SystemInformationClass, void* SystemInformation, int SystemInformationLength, out int ReturnLength);


            /// <summary>
            /// 
            /// For the processInformationLength : http://undocumented.ntinternals.net/index.html?page=UserMode%2FUndocumented%20Functions%2FNT%20Objects%2FProcess%2FPROCESS_INFORMATION_CLASS.html
            /// </summary>
            ...
            /// <example>
            /// <code>
            /// IntPtr test = (IntPtr)Enumerations._PRIORITY_CLASS.HIGH_PRIORITY_CLASS;
            /// NtSetInformationProcess(System.Diagnostics.Process.GetCurrentProcess().Handle, PROCESSINFOCLASS.ProcessPriorityClass, in test, 0x002);
            /// </code>
            /// </example>
            /// <returns>NTSTATUS</returns>
            [DllImport("ntdll.dll", PreserveSig = false, SetLastError = true)]
            public static extern NTSTATUS NtSetInformationProcess(IntPtr processHandle, Enumerations._PROCESS_INFO_CLASS processInformationClass, in IntPtr SystemInformation, IntPtr processInformationLength);


            /// <summary>
            /// Wrapper of NtSetInformationProcess.
            /// </summary>
            /// <param name="processHandle"></param>
            /// <param name="processInformationClass"></param>
            /// <param name="SystemInformation"></param>
            ...
            /// <code>
            /// IntPtr test = (IntPtr)Enumerations._PRIORITY_CLASS.HIGH_PRIORITY_CLASS;
            /// NtDll.Functions.NtSetInformationProcessWrapper(System.Diagnostics.Process.GetCurrentProcess().Handle, NtDll.Enumerations._PROCESS_INFO_CLASS.ProcessPriorityClass,  test); 
            /// </code>
            /// </example>
            /// <returns>NTSTATUS</returns>
            public static NTSTATUS NtSetInformationProcessWrapper(IntPtr processHandle, Enumerations._PROCESS_INFO_CLASS processInformationClass, IntPtr SystemInformation)
            {

                uint processInformationLength = 0;


                switch (processInformationClass)
                {
                    case (Enumerations._PROCESS_INFO_CLASS.ProcessPriorityClass):

                        processInformationLength = 0x002;

                        uint conversion = (uint)SystemInformation;

                        bool check = Enum.IsDefined(typeof(Enumerations._PRIORITY_CLASS), conversion);

                        if (check == false)
                            throw new Classes.InvalidParameter(SystemInformation.ToString());

                        break;

                }
                return NtSetInformationProcess(processHandle, processInformationClass, in SystemInformation, (IntPtr)processInformationLength);
            }
            ...
            Enumerations._PROCESS_INFO_CLASS ProcessInformationClass,
            ref void* ProcessInformation,
            IntPtr ProcessInformationLength,//Really Important because of 32 and 64 bits (replace ulong and uint)
            ...
            [DllImport("ntdll.dll", PreserveSig = false, SetLastError = true)]
            public static unsafe extern NTSTATUS NtSetInformationThread(void* ThreadHandle, Enumerations._THREAD_INFO_CLASS ProcessInformationClass, ref void* ThreadInformation, IntPtr ThreadInformationLength);


            [DllImport("ntdll.dll")]
            public static unsafe extern NTSTATUS NtQueryInformationThread(
            void* ProcessHandle,
            Enumerations._THREAD_INFO_CLASS ProcessInformationClass,
            ref void* ProcessInformation,
            IntPtr ProcessInformationLength,//Really Important because of 32 and 64 bits (replace ulong and uint)
            out int ReturnLength);
            ...
            [DllImport("ntdll.dll", CharSet = CharSet.Unicode)]
            public static unsafe extern NTSTATUS RtlGetNativeSystemInformation(Enumerations._SYSTEM_INFORMATION_CLASS SystemInformationClass, void* SystemInformation, int SystemInformationLength, out int ReturnLength);

            /*
            [DllImport("ntdll.dll", CharSet = CharSet.Unicode)]
            public static unsafe extern NTSTATUS ZwQuerySystemInformation(Enumerations._SYSTEM_INFORMATION_CLASS SystemInformationClass, void* SystemInformation, int SystemInformationLength, out int ReturnLength);
            */

            [DllImport("ntdll.dll")]
            public static extern void DbgBreakPoint(); //same effect as DebugBreakProcess from kernel 32 BUT will crash your apps if not debugger attached

            [DllImport("ntdll.dll")]
            public static extern void DbgUserBreakPoint(); //same
        ...
        public sealed class Structures
        {
            ...
            public struct _SYSTEM_BOOT_ENVIRONMENT_INFORMATION
            {
                ...
                public Enumerations._FIRMWARE_TYPE FirmwareType;   //GOOD
                public ulong BootFlags;
            }


            [StructLayout(LayoutKind.Sequential)]
            public struct _SYSTEM_PROCESSOR_INFORMATION
            {
                public ushort ProcessorArchitecture;//
                public ushort ProcessorLevel;
                public ushort ProcessorRevision;
                public ushort MaximumProcessors;//16 threads
                public int ProcessorFeatureBits;
            }
            ...
            {
                public Int64 IdleProcessTime;
                public Int64 IoReadTransferCount;
                public Int64 IoWriteTransferCount;
                public Int64 IoOtherTransferCount;
            ...
            */
            ...
            [StructLayout(LayoutKind.Sequential)]
            public struct _SYSTEM_BASIC_INFORMATION
            {
            ...
            [StructLayout(LayoutKind.Sequential)]
            public struct _SYSTEM_TIMEOFDAY_INFORMATION
            {
                public Int64 BootTime;
                public Int64 CurrentTime;
                public Int64 TimeZoneBias;
            ...
            [StructLayout(LayoutKind.Sequential)]
            public struct _SYSTEM_PROCESSOR_IDLE_INFORMATION
            {
            ...
            [StructLayout(LayoutKind.Sequential)]
            public struct _SYSTEM_DEVICE_INFORMATION
            {
                public uint NumberOfDisks;    //GOOD
                public uint NumberOfFloppies;
                public uint NumberOfCdRoms;
                public uint NumberOfTapes;
                public uint NumberOfSerialPorts;
                public uint NumberOfParallelPorts;
            }
            ...
            public struct _SYSTEM_PROCESSOR_PERFORMANCE_INFORMATION
            {
                ...
                public Int64 DpcTime;
                public Int64 InterruptTime;
                uint InterruptCount;
            }


            [StructLayout(LayoutKind.Sequential)]
            public struct _SYSTEM_QUERY_TIME_ADJUST_INFORMATION
            {
                uint TimeAdjustment;
                uint TimeIncrement;
                Boolean Enable;
            ...
            public unsafe struct _SYSTEM_PROCESS_INFORMATION
            {
                public uint NextEntryOffset;
                public uint NumberOfThreads;
                public LARGE_INTEGER WorkingSetPrivateSize; // since VISTA               
                ...
                public Classes.UnicodeString ImageName;
                public int BasePriority; //KPRIORITY
                public IntPtr UniqueProcessId;
                public IntPtr InheritedFromUniqueProcessId;
                public uint HandleCount;
                public uint SessionId;
                public UIntPtr UniqueProcessKey; // since VISTA (requires SystemExtendedProcessInformation)
                public UIntPtr PeakVirtualSize; //SIZE_T
                public UIntPtr VirtualSize;
                public uint PageFaultCount;
                public UIntPtr PeakWorkingSetSize; //SIZE_T
                public UIntPtr WorkingSetSize; //SIZE_T
                public UIntPtr QuotaPeakPagedPoolUsage; //SIZE_T
                public UIntPtr QuotaPagedPoolUsage; //SIZE_T
                public UIntPtr QuotaPeakNonPagedPoolUsage; //SIZE_T
                public UIntPtr QuotaNonPagedPoolUsage; //SIZE_T
                public UIntPtr PagefileUsage; //SIZE_T
                public UIntPtr PeakPagefileUsage; //SIZE_T
                public UIntPtr PrivatePageCount; //SIZE_T
            ...
            //This structure doesn't exist : I've created it for wrapper
            [StructLayout(LayoutKind.Sequential, CharSet = CharSet.Unicode)]
            public unsafe struct _SYSTEM_PROCESS_THREADS_INFORMATION
            {
                public _SYSTEM_PROCESS_INFORMATION ProcInfo;
                public List<_SYSTEM_THREAD_INFORMATION> ThreadInfo;
            }

            //https://doxygen.reactos.org/db/d35/struct__SYSTEM__THREAD__INFORMATION.html
            [System.Runtime.InteropServices.StructLayoutAttribute(System.Runtime.InteropServices.LayoutKind.Sequential)]
            public unsafe struct _SYSTEM_THREAD_INFORMATION
            {
                public LARGE_INTEGER KernelTime;//Number of 100-nanosecond intervals spent executing kernel code.
                public LARGE_INTEGER UserTime;//Number of 100-nanosecond intervals spent executing user code.
                public LARGE_INTEGER CreateTime;//System time when the thread was created.
                public uint WaitTime;//Time spent in ready queue or waiting (depending on the thread state).
                /// PVOID->void*
                public void* StartAddress;//Start address of the thread.
                public _CLIENT_ID ClientId;//ID of the thread and the process owning the thread.
                public int KPriority;//Dynamic thread priority. https://stackoverflow.com/questions/38966507/what-are-available-kpriorities : betwenn 0 and 32
                public int BasePriority;//Base thread priority.
                public uint ContextSwitchCount;//Total context switches.
                public uint ThreadState;//Current thread state.
                /// KWAIT_REASON->_KWAIT_REASON
                public Enumerations._KWAIT_REASON WaitReason;//The reason the thread is waiting.
                public uint PadPadAlignment;//
                public uint dwTickCount;//
            }

            //The CLIENT_ID structure contains identifiers of a process and a thread.
            [System.Runtime.InteropServices.StructLayoutAttribute(System.Runtime.InteropServices.LayoutKind.Sequential)]
            public unsafe struct _CLIENT_ID
            {
                /// HANDLE->void*
            ...
            public unsafe struct _SYSTEM_EXTENDED_PROCESS_INFORMATION
            {
                public uint NextEntryOffset;
                public uint NumberOfThreads;
                public ulong SpareLi1;
                public ulong SpareLi2;
                public ulong SpareLi3;
                ...
                public uint HandleCount;
                public uint SessionId;
                public void* PageDirectoryBase;
                public VM_COUNTERS VirtualMemoryCounters;
                public UIntPtr PrivatePageCount;
                public IO_COUNTERS IoCounters;
                public _SYSTEM_EXTENDED_THREAD_INFORMATION Threads;
            }

            public unsafe struct _SYSTEM_EXTENDED_THREAD_INFORMATION
            {
                public _SYSTEM_THREAD_INFORMATION ThreadInfo;
                public void* StackBase;
                public void* StackLimit;
                public void* Win32StartAddress;
                public void* TebAddress; /* This is only filled in on Vista and above */
            ...
            [StructLayout(LayoutKind.Sequential)]
            public struct _SYSTEM_PROCESSOR_POWER_INFORMATION
            {
                public byte CurrentFrequency;
                public byte ThermalLimitFrequency;
                public byte ConstantThrottleFrequency;
                public byte DegradedThrottleFrequency;
                public byte LastBusyFrequency;
                public byte LastC3Frequency;
                public byte LastAdjustedBusyFrequency;
                public byte ProcessorMinThrottle;
                public byte ProcessorMaxThrottle;
                public uint NumberOfFrequencies;
                public uint PromotionCount;
                public uint DemotionCount;
                public uint ErrorCount;
                public uint RetryCount;
                public ulong CurrentFrequencyTime;
                public ulong CurrentProcessorTime;
                public ulong CurrentProcessorIdleTime;
                public ulong LastProcessorTime;
                public ulong LastProcessorIdleTime;
            }
            ...
            [StructLayout(LayoutKind.Sequential)]
            public struct _SYSTEM_PAGEFILE_INFORMATION
            {
                public uint NextEntryOffset;//return 0 ??
                public uint TotalSize;//return 0 ??
                public uint TotalInUse;//return 0 ??
                public uint PeakUsage;//return 0 ??
                public UNICODE_STRING PageFileName;
            }

            [StructLayout(LayoutKind.Sequential)]
            public struct _SYSTEM_FILECACHE_INFORMATION
            {
            ...
            //Not Tested
            [StructLayout(LayoutKind.Sequential)]
            public struct _SYSTEM_DPC_BEHAVIOR_INFORMATION
            {
                public uint Reserved;
                public uint DpcQueueDepth;
            ...
            [StructLayout(LayoutKind.Sequential)]
            public struct _SYSTEM_INTERRUPT_INFORMATION
            {
                public uint ContextSwitches;
            ...
            {
                public NtDll.NTSTATUS ExitStatus;
            ...
            [StructLayout(LayoutKind.Sequential)]
            public struct _PROCESS_EXTENDED_BASIC_INFORMATION
            {
                public UIntPtr Size;
                public _PROCESS_BASIC_INFORMATION BasicInfo;
                public uint Flags;
                /*
                public uint IsProtectedProcess;
                public uint IsWow64Process;
                public uint IsProcessDeleting;
                */
            }

            [StructLayout(LayoutKind.Sequential)]
            public unsafe struct _THREAD_BASIC_INFORMATION
            {
                public NTSTATUS ExitStatus;
                public void* TebBaseAddress; //pointer to TEB Structure
            ...
            //https://doxygen.reactos.org/dc/dbf/struct__SYSTEM__HANDLE__INFORMATION.html
            [StructLayout(LayoutKind.Sequential)]
            public unsafe struct _SYSTEM_HANDLE_INFORMATION
            {
                public uint NumberOfHandles;
                public _SYSTEM_HANDLE_TABLE_ENTRY_INFO Handles;//return information about system.exe     
                public uint Count;
                public _SYSTEM_HANDLE_ENTRY Handle2s;

            }

            //https://doxygen.reactos.org/d0/d9e/struct__SYSTEM__HANDLE__TABLE__ENTRY__INFO.html
            [StructLayout(LayoutKind.Sequential)]
            public unsafe struct _SYSTEM_HANDLE_TABLE_ENTRY_INFO
            {
            ...
            //https://doxygen.reactos.org/d9/d0d/struct__SYSTEM__HANDLE__ENTRY.html
            [StructLayout(LayoutKind.Sequential)]
            public unsafe struct _SYSTEM_HANDLE_ENTRY
            {
        ...
        public sealed class Enumerations
        {
            ...
            //I don't remember where I've found that.
            public enum _HARDERROR_RESPONSE_OPTION
            {
            ...
            public enum _HARDERROR_RESPONSE
            {
            ...
            //from  : http://ntoskrnl.org/
            //Class , ID , Associated Data Type
            public enum _SYSTEM_INFORMATION_CLASS
            {
                SystemBasicInformation = 0x0000,                    //SYSTEM_BASIC_INFORMATION
                SystemProcessorInformation = 0x0001,                //SYSTEM_PROCESSOR_INFORMATION
                ...
                SystemDeviceInformation = 0x0007,                   //SYSTEM_DEVICE_INFORMATION
                SystemProcessorPerformanceInformation = 0x0008,     //SYSTEM_PROCESSOR_PERFORMANCE_INFORMATION
                SystemFlagsInformation = 0x0009,                    //SYSTEM_FLAGS_INFORMATION
                SystemCallTimeInformation = 0x000A,
                SystemModulesInformation = 0x000B,                  //SYSTEM_MODULES_INFORMATION | RTL_PROCESS_MODULES

                SystemLocksInformation = 0x000C,                    //RTL_PROCESS_LOCKS
                SystemStackTraceInformation = 0x000D,
                SystemPagedPoolInformation = 0x000E,
                SystemNonPagedPoolInformation = 0x000F,
                SystemHandleInformation = 0x0010,                   //SYSTEM_HANDLE_INFORMATION
                SystemObjectInformation = 0x0011,                   //SYSTEM_OBJECT_INFORMATION | SYSTEM_OBJECTTYPE_INFORMATION

                SystemPageFileInformation = 0x0012,                 //SYSTEM_PAGEFILE_INFORMATION
                SystemVdmInstemulInformation = 0x0013,
                SystemVdmBopInformation = 0x0014,
                SystemFileCacheInformation = 0x0015,                //SYSTEM_FILECACHE_INFORMATION
                SystemPoolTagInformation = 0x0016,                  //SYSTEM_POOLTAG_INFORMATION
                SystemInterruptInformation = 0x0017,                //SYSTEM_INTERRUPT_INFORMATION
                SystemDpcBehaviorInformation = 0x0018,              //SYSTEM_DPC_BEHAVIOR_INFORMATION
                SystemFullMemoryInformation = 0x0019,
                SystemLoadGdiDriverInformation = 0x001A,
                SystemUnloadGdiDriverInformation = 0x001B,
                SystemTimeAdjustmentInformation = 0x001C,           //SYSTEM_QUERY_TIME_ADJUST_INFORMATION | SYSTEM_SET_TIME_ADJUST_INFORMATION
                ...
                SystemExceptionInformation = 0x0021,                //SYSTEM_EXCEPTION_INFORMATION
                SystemCrashDumpStateInformation = 0x0022,
                SystemKernelDebuggerInformation = 0x0023,           //SYSTEM_KERNEL_DEBUGGER_INFORMATION
                SystemContextSwitchInformation = 0x0024,            //SYSTEM_CONTEXT_SWITCH_INFORMATION
                SystemRegistryQuotaInformation = 0x0025,            //SYSTEM_REGISTRY_QUOTA_INFORMATION
                ...
                SystemProcessorIdleInformation = 0x002A,            //SYSTEM_PROCESSOR_IDLE_INFORMATION
                SystemLegacyDriverInformation = 0x002B,
                SystemCurrentTimeZoneInformation = 0x002C,          //RTL_TIME_ZONE_INFORMATION
                ...
                SystemProcessorPowerInformation = 0x003D,          //SYSTEM_PROCESSOR_POWER_INFORMATION
                SystemEmulationBasicInformation = 0x003E,          //SYSTEM_BASIC_INFORMATION
                SystemEmulationProcessorInformation = 0x003F,       //SYSTEM_PROCESSOR_INFORMATION
                SystemExtendedHandleInformation = 0x0040,          //SYSTEM_HANDLE_INFORMATION_EX
                SystemLostDelayedWriteInformation = 0x0041,
                SystemBigPoolInformation = 0x0042,                 //SYSTEM_BIGPOOL_INFORMATION
                SystemSessionPoolTagInformation = 0x0043,          //SYSTEM_SESSION_PROCESS_INFORMATION
                SystemSessionMappedViewInformation = 0x0044,       //SYSTEM_SESSION_MAPPED_VIEW_INFORMATION
                ...
                SystemModuleInformationEx = 0x004D,                 //RTL_PROCESS_MODULES
                ...
                SystemProcessorPowerInformationEx = 0x0055,         //SYSTEM_FILECACHE_INFORMATION
                ...
                SystemBootEnvironmentInformation = 0x005A,          //SYSTEM_BOOT_ENVIRONMENT_INFORMATION
                ...
                SystemCpuQuotaInformation = 0x0071,                 //PS_CPU_QUOTA_QUERY_INFORMATION
                ...
                SystemBasicPerformanceInformation = 0x007B,          //SYSTEM_BASIC_PERFORMANCE_INFORMATION
                ...
                SystemProcessorPerformanceInformationEx = 0x008D,          //SYSTEM_PROCESSOR_PERFORMANCE_INFORMATION_EX
                SystemSpare0 = 0x008E,
                ...
                SystemKernelDebuggerInformationEx = 0x0095,
                SystemBootMetadataInformation = 0x0096,
                SystemSoftRebootInformation = 0x0097,
                SystemElamCertificateInformation = 0x0098,
                SystemOfflineDumpConfigInformation = 0x0099,
                SystemProcessorFeaturesInformation = 0x009a,
                SystemRegistryReconciliationInformation = 0x009b
            }

            public enum _FIRMWARE_TYPE
            {
                FirmwareType_Unknown,
                FirmwareType_Bios,
                FirmwareType_Uefi,
                FirmwareType_Max
            }
            ...
            /*
             * Disovered by Arsium with NtQueryInformationProcess and ProcessPriorityClass
             * Note : The priority class found on MSDN seems not to be the same for Nt Functions
             * if you don't trust me , you should try the following code and go to your taskmanager :)
             * IntPtr test = (IntPtr)Enumerations._PRIORITY_CLASS.HIGH_PRIORITY_CLASS;
             * NtSetInformationProcess(System.Diagnostics.Process.GetCurrentProcess().Handle, PROCESSINFOCLASS.ProcessPriorityClass, in test, 0x002);
             */
            public enum _PRIORITY_CLASS : uint
            {
                NORMAL_PRIORITY_CLASS = 0x200,
                ABOVE_NORMAL_PRIORITY_CLASS = 0x600,
                HIGH_PRIORITY_CLASS = 0x300,
                REALTIME_PRIORITY_CLASS = 0x400,
                BELOW_NORMAL_PRIORITY_CLASS = 0x500,
                IDLE_PRIORITY_CLASS = 0x100,
                //PROCESS_MODE_BACKGROUND_BEGIN = 0x1000000,// 'Windows Vista/2008 and higher
                //PROCESS_MODE_BACKGROUND_END = 0x2000000,//   'Windows Vista/2008 and higher            
            }

            [Flags]
            public enum _SHUTDOWN_ACTION : uint
            {
                ShutdownNoReboot = 0,
                ShutdownReboot = 1,
                ShutdownPowerOff = 2
            ...
            //https://www.powershellgallery.com/packages/PSReflect-Functions/1.1/Content/Enumerations%5CTHREADINFOCLASS.ps1
            [Flags]
            public enum _PROCESS_INFO_CLASS
            {
            ...
            [Flags]
            public enum _THREAD_INFO_CLASS
            {
                ...
                MaxThreadInfoClass = 0x30
            };

            public enum _KWAIT_REASON : int
            {
                Executive,
                FreePage,
                PageIn,
        ...
        public sealed class Classes
        {
            ...
            public sealed class InvalidParameter : Exception
            {
                ...
                public InvalidParameter(string name)
                    : base(String.Format("{0} is not contains in Enumerations_PRIORITY_CLASS", name))
                {
